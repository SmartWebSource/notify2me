            ...
            <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('next_meeting_date', null, ['class'=>'form-control']) !!}
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('concern_person_name', null, ['class'=>'form-control']) !!}
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="concern_person_phone" class="control-label">Concern Person Phone {!! validation_error($errors->first('concern_person_phone'),'concern_person_phone') !!}</label>
                            {!! Form::text('concern_person_phone', null, ['class'=>'form-control']) !!}
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="title" class="control-label">Concern Person Designation {!! validation_error($errors->first('concern_person_designation'),'concern_person_designation') !!}</label>
                            {!! Form::text('concern_person_designation', null, ['class'=>'form-control']) !!}
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    {!! Form::textarea('meeting_details', null, ['class'=>'form-control','rows'=>4]) !!}
                </div>
                <div class="form-group">
